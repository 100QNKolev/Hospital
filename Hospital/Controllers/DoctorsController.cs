...
namespace Hospital.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FistName,LastName,Description")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FistName,LastName,Description")] Doctor doctor)
        {
            if (id != doctor.Id)
            {
                return NotFound();
